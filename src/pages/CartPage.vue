  ...
  methods: {
    ...
    validateForm() {
      ...
      if (!this.order.first_name.trim()) {
        ...
        this.order.first_name.length < 3 ||
        this.order.first_name.length > 20
      ) {
        this.errors.first_name = "Il nome deve avere tra 3 e 20 caratteri.";
        valid = false;
      } else {
        this.order.first_name =
          this.order.first_name.charAt(0).toUpperCase() +
          this.order.first_name.slice(1).toLowerCase();
      }
      ...
      if (!this.order.last_name.trim()) {
        ...
        this.order.last_name.length < 3 ||
        this.order.last_name.length > 30
      ) {
        this.errors.last_name = "Il cognome deve avere tra 3 e 30 caratteri.";
        valid = false;
      } else {
        this.order.last_name =
          this.order.last_name.charAt(0).toUpperCase() +
          this.order.last_name.slice(1).toLowerCase();
      }
      ...
      if (!this.order.phone_number.trim()) {
        ...
        this.errors.phone_number =
          "Il numero di telefono deve contenere 10 cifre numeriche.";
        valid = false;
      }
      ...
      if (!this.order.address.trim()) {
        ...
        this.order.address.length < 3 ||
        this.order.address.length > 30
      ) {
        ...
        this.order.address =
          this.order.address.charAt(0).toUpperCase() +
          this.order.address.slice(1).toLowerCase();
      }
